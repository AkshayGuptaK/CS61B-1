...
class Maker {
    ...
    void readFileAges(String fileInfoName) {
        ...
        int age;
        try {
            FileReader infoName = new FileReader(fileInfoName);
            Scanner inp = new Scanner(infoName);
            ...
            error("Error: file can't be found");
        }
    }
    ...
    void readMakefile(String makefileName) {
        ...
        commands = null;
        try {
            FileReader makeFile = new FileReader(makefileName);
